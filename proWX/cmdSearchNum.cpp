...
cmdSearchNum::cmdSearchNum(void)
: cmdCommon()
{
}
...
void cmdSearchNum::init()
{
	openFile(L"d:/yingcai/project/proWX/Debug/cmd/SearchNum.txt");
}

bool cmdSearchNum::parseFile(const char* bufCmd)
{
