...
cmdSetKeyNum::cmdSetKeyNum(void)
: cmdCommon()
{
}
...
void cmdSetKeyNum::init()
{
	openFile(L"d:/yingcai/project/proWX/Debug/cmd/SetKeyNum.txt");
}

bool cmdSetKeyNum::parseFile(const char* bufCmd)
{
