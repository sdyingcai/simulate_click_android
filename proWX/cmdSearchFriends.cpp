...
cmdSearchFriends::cmdSearchFriends(void)
: cmdCommon()
{
}
...
void cmdSearchFriends::init()
{
	openFile(L"d:/yingcai/project/proWX/Debug/cmd/SearchFriends.txt");
}

bool cmdSearchFriends::parseFile(const char* bufCmd)
{
