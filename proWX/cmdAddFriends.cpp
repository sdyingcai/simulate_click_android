...
cmdAddFriends::cmdAddFriends(void)
: cmdCommon()
{
}
...
void cmdAddFriends::init()
{
	openFile(L"d:/yingcai/project/proWX/Debug/cmd/AddFriends.txt");
}

bool cmdAddFriends::parseFile(const char* bufCmd)
{
